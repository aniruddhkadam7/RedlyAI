...
export const STANDARD_VIEW_TEMPLATES: readonly ViewTemplate[] = [
  ...
  },
  {
    ...
    description: 'Cross-layer traceability from applications to the technologies they are hosted on.',
    viewType: 'ImpactView',
  ...
  },
  {
    ...
    allowedRelationshipTypes: ['IMPACTS', 'DECOMPOSES_TO', 'COMPOSED_OF', 'REALIZED_BY', 'HOSTED_ON'],
    layoutType: 'Layered',
    orientation: 'LeftToRight',
