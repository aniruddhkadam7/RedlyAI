...
const BUILT_IN_VIEWPOINTS: readonly ViewpointDefinition[] = Object.freeze(
  [
    ...
    },
    {
      ...
      allowedRelationshipTypes: ['DEPENDS_ON', 'PROVIDES'],
      defaultLayout: 'grid',
    ...
    },
    {
      ...
      description: 'Layered technology-centric view of hosting relationships.',
    },
    {
      id: 'capability-map',
      name: 'Capability Map',
    ...
    },
    {
      ...
      allowedRelationshipTypes: ['INTEGRATES_WITH', 'HOSTED_ON'],
      defaultLayout: 'elkjs',
      description: 'Operational view of application-to-application dependencies and hosting.',
    },
    {
      id: 'service-traceability',
      name: 'Service Traceability',
      allowedElementTypes: ['Application', 'ApplicationService', 'BusinessService'],
      allowedRelationshipTypes: ['PROVIDES', 'SUPPORTS', 'CONSUMES', 'DEPENDS_ON'],
      defaultLayout: 'elkjs',
